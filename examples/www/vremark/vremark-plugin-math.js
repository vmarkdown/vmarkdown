define("vremark-plugin-math", [], function() { return /******/ (function(modules) { // webpackBootstrap
...
/******/ 		return __webpack_require__.p + "" + ({"7":"vendors~vremark-plugin-math-libs"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
module.exports = {
    ...
    mounted() {
        var self = this;
        __webpack_require__.e(/* require.ensure | vremark-plugin-math-libs */ 7).then((function(){
