define("vremark-plugin-math", [], function () {
    return function (e) {
        function t(t) {
            for (var n, o, i = t[0], a = t[1], s = 0, c = []; s < i.length; s++) o = i[s], r[o] && c.push(r[o][0]), r[o] = 0;
        ...
        o.e = function (e) {
            ...
            if (0 !== n) if (n) t.push(n[2]); else {
                ...
                u.charset = "utf-8", u.timeout = 120, o.nc && u.setAttribute("nonce", o.nc), u.src = function (e) {
                    return o.p + "./" + ({6: "vendors~vremark-plugin-math-libs"}[e] || e) + ".b2ecbe60aec62b7259a1.min.js"
                }(e), a = function (t) {
        ...
        n(4), e.exports = {
            ...
            props: {inline: {type: Boolean, default: !1}, code: {type: String, required: !0}},
            data() {
                return {result: this.code || ""}
            },
            render(e) {
                return e(this.inline ? "span" : "p", {
            ...
            methods: {
                compile(e) {
                    try {
                        var t = e.renderToString(this.code, {displayMode: !this.inline, macros: {}});
                        this.result = t
                    } catch (e) {
                    }
                }
